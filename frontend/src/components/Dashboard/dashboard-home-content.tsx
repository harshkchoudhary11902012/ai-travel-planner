...
export function DashboardHomeContent() {
	const { user, userLoading, trips } = useDashboardData();
			...
			<Stack gap="xl">
				<div>
					...
					<Text c="dimmed" size="sm">
						Overview of your workspace: plan trips, review AI output, and manage itineraries in
						one place.
					</Text>
				</div>
					...
					<Card withBorder padding="lg" radius="md">
						<Group justify="space-between" wrap="nowrap" align="center">
							...
							<RingProgress
								size={56}
								thickness={6}
								sections={[{ value: tripCount === 0 ? 15 : 100, color: "mainColor" }]}
								label={
						...
						<Stack gap="md">
							...
							<Stack gap="md" mt={30}>
								<Group justify="space-between" wrap="nowrap">
									...
									<Button component={Link} href="/dashboard/trips" variant="subtle" size="xs">
										View all
									</Button>
								</Group>
								{recent.length === 0 ? (
									<Paper withBorder p="md" radius="md" h={140}>
										...
										<Button component={Link} href="/dashboard/plan" fullWidth size="md">
											Start planning
										</Button>
									</Paper>
								) : (
							...
							<SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md">
								...
								>
									<Group wrap="nowrap" align="flex-start">
										<ThemeIcon size={42} radius="md" variant="light" color="mainColor">
											<IconSparkles size={22} stroke={1.5} />
										</ThemeIcon>
										<Stack gap={4}>
											<Text fw={700}>Plan a trip</Text>
											<Text size="sm" c="dimmed">
												Destination, days, budget tier, and interests — then generate a
								...
								>
									<Group wrap="nowrap" align="flex-start">
										...
										<Stack gap={4}>
											...
											<Text size="sm" c="dimmed">
												Browse saved plans. Each trip holds itinerary edits, revisions, and
												history.
											</Text>
										</Stack>
									</Group>
								...
								<Card withBorder padding="lg" radius="md">
									<Group wrap="nowrap" align="flex-start">
										...
										<Stack gap={4}>
											...
											<Text size="sm" c="dimmed">
												Flights, stay, food, and activities are estimated per trip after
												generation. Open any trip to see the breakdown.
											</Text>
										</Stack>
									</Group>
								</Card>
								<Card withBorder padding="lg" radius="md">
									<Group wrap="nowrap" align="flex-start">
										...
										<Stack gap={4}>
											...
											<Text size="sm" c="dimmed">
												AI-suggested stays by destination and budget appear on each trip
												detail page.
											</Text>
										</Stack>
									</Group>
