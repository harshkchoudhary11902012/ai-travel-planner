...
export default function DayPanel({
  ...
  return (
    <Accordion
      ...
      variant="contained"
      defaultValue={`day-${day.dayNumber}`}
    >
        ...
        <Accordion.Panel>
          <Stack gap="md">
              ...
              {day.activities.map((a) => (
                ...
                >
                  <Group justify="space-between" align="flex-start">
                    ...
                    <ActionIcon color="red" variant="subtle" onClick={() => handleRemove(a.id)}>
                      <IconTrash size={16} />
                    </ActionIcon>
                  </Group>
                </Box>
            ...
            <Stack gap={8}>
              ...
              />
              <Button onClick={handleRegenerate} loading={regenLoading} leftSection={<IconSparkles size={16} />}>
